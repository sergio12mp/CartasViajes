...
Las tareas de revisión se recogen en [LEGAL-REVIEW.md](LEGAL-REVIEW.md). La web resume los puntos de privacidad pendientes en `/privacidad#revision`; los detalles de cookies están disponibles en un desplegable. Las condiciones muestran el acceso de beta o los pagos según `paymentsEnabled()`, sin modificar la configuración de compras.
